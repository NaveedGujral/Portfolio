...
import LandingVis from "./components/LandingVis";
...
export default function Home() {
  ...
  const [visualVidSrc, setVisualVidSrc] = useState(null);
  ...
  // const projectsInView = useInView(projectsRef, { amount: 0 });
  // const footerInView = useInView(footerRef, { amount: 0 });
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* <div className="w-1/2 h-1/2 bg-zinc-700 rounded-2xl border-white border-2 z-20"></div> */}

        {/* <div className="w-1/2 h-1/2 bg-zinc-700 bg-opacity-25 backdrop-blur-lg rounded-2xl border-zinc-600 border-[1px] z-20"></div>  */}
...
//   <div id="intro" className="content-wrapper h-[150vh]">
...
//           className="relative w-full h-full z-10 rounded-full scale-[0.99]"
//           loading="eager"
//           width={1064}
//           height={1076}
...
//   <div
//     id="tech"
//     className="content-wrapper pt-40 pb-20"
//   >
//     <div className="content-container h-screen flex-col justify-around">
//       <div className="w-[90%] md:w-full flex flex-col gap-6 sm:gap-12 justify-around relative p-2">
...
//   <div
//     id="footer"
//     className="h-[50vh] sm:h-[34vh] w-full flex justify-center items-center"
//     ref={footerRef}
//   >
